...
<a href="<?php echo admin_url('admin.php?page=sinetiks_schools_list')?>">&laquo; Back to list</a>
...
<input type='submit' name="delete" value='Delete' class='button' onclick="return confirm(Seguro?')">
</form>
<?php }?>
