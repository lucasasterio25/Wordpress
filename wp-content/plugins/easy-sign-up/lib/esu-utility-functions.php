...
function esu_options_array(){
  $e_options = array (
        ...
        array("name" => __('Thank You Email to Client','easy-sign-up'),
              "desc" => '<p><code>#fullname#</code>'.__(' is the placeholder for the name field of the form.<br> When you customize the text <strong>remember to add it back in if you want to personalize</strong> the confirmation letter.</p>','easy-sign-up').
                '<p class="description">'.
              ...
              "std" => __("Hi #fullname# Thank you for visiting our website<br>We hope that you found it informative.<br><br>Regards,<br> ".WP_BLOG_NAME,'easy-sign-up'),
              "type" => "wp_editor"),
      /*
        array("name" => __('Slam Spam with Akismet','easy-sign-up'),
              "desc" => __('This requires you to have the <a href="http://wordpress.org/extend/plugins/akismet/" target="_blank">Akismet plugin</a> installed and enable.' ,'easy-sign-up'),
